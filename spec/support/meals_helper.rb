def create_meal(name: 'Meal name',
                portions: 6,
                price_per_portion_pence: 3.5,
                recipe_title: 'Recipe title')
  find("#nav-bar > a[href='#{meals_path}']").click
  click_link 'New Meal'
  fill_in 'Name', with: name
  fill_in 'Portions', with: portions
  fill_in :meal_price_per_portion_pence, with: price_per_portion_pence
...
def edit_meal(meal, recipe_with_ingredients)
  ...
  fill_in :meal_price_per_portion_pence, with: "#{meal.price_per_portion_pence} edit"
